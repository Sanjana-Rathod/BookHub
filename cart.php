...
if (isset($_POST['delete'])) {
    $bookIsbnToDelete = $_POST['delete'];
    removeFromCart($bookIsbnToDelete);
        ...
        <table class="table">
            ...
            foreach ($_SESSION['cart'] as $isbn => $qty) {
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" class="btn btn-danger btn-sm" name="delete" value="<?php echo $isbn; ?>">
                            Delete
                        </button>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <th>&nbsp;</th> <!-- Add an empty column for spacing -->
            </tr>
        </table>
        <button type="submit" class="btn btn-primary" name="save_change">
