...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row">
            <a class="navbar-brand" href="index.php" col-md-3>BookHub</a>
    ...
    <div class="jumbotron" style="  background: url('https://www.pressconnects.com/gcdn/-mm-/98374d179f0e80700b20275026f741aa0e6bb90c/c=0-51-999-616/local/-/media/2016/10/17/CNYGroup/Ithaca/636122978177310148-20150227-shutterstock-225070897.jpg');no-repeat center center;background-size: cover;height:400px;" >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto;background-color: rgb(0,0,0); background-color: rgba(0,0,0, 0.4); color: white;font-weight: bold;border: 3px solid #f1f1f1;"><b>WELCOME TO THE BOOKHUB</b></h1>   
      </div>
    </div>
    <?php } ?>
